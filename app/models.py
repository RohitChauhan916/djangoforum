...
class UserProfile(models.Model):
    ...
    dob = models.CharField(verbose_name="D.O.B", max_length=50,   null=True)
    department = models.CharField(verbose_name="Department", max_length=100, null=True)
    phone_number = models.CharField(verbose_name="Phone Number", max_length=20, null=True)
    web_address = models.CharField(verbose_name="Web Address", max_length=100, null=True)
    location = models.CharField(verbose_name="Location", max_length=100, null=True)
    hire_date = models.CharField(verbose_name="Hire Date", max_length=100, null=True)
    about = models.TextField(verbose_name="About", max_length=100, null=True)
    gender = models.CharField(verbose_name="Gender", max_length=20, null=True)
    zone = models.CharField(verbose_name="Zone", max_length=100,   null=True)
    aniversary = models.CharField(verbose_name="Aniversary", max_length=100,   null=True)
    designation = models.CharField(verbose_name="Designation", max_length=100,   null=True)
    reporting_to = models.CharField(verbose_name="Reporting To", max_length=100,   null=True)
    cover_photo = models.ImageField(verbose_name="Cover", upload_to="cover",   null=True)
...
class suggestion(models.Model):
    ...
    subject = models.CharField(verbose_name="Subject", max_length=200,   null=True)
